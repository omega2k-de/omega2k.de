...
# Optionales Spiel-Format (wenn du es als echtes Spiel nutzen willst)
- Lies nur die Frage vor.
- Lass erst die Kinder antworten („Was denkst du?“).
- Dann lies die Antwort vor.
- Zum Schluss nur einen Satz: „Krankheit“ und „Heil-Regelkreis“ – wie ein Zauberspruch: „Symptom erkennen, Regel finden“.

Wenn du möchtest, baue ich dir daraus als nächsten Schritt:
1) eine „Kinder-Kurzversion“ (je Karte nur 2–3 Sätze),
2) eine „Erwachsenen-Version“ (je Karte mit einem konkreten Beispiel aus Alltag/Politik/Ökonomie),
3) oder ein druckbares A4-Kartenset (Markdown so formatiert, dass du es direkt in PDF/Print übertragen kannst).
